...
namespace DeDauwJeroen
{
    ...
    class FileDownloader : System.Object, IDisposable
    {
        ...
        /// <summary>Gets the total size of all files together. Only avaible when the FileDownloader supports progress</summary>
        ...
        /// <summary>Gets the total download percentage. Only avaible when the FileDownloader supports progress</summary>
